...
- [Locus](https://github.com/erichuang1425/locus) (Not published yet): a Chromium new-tab workspace for saved tabs, notes, todos, reminders, and small personal trackers. No server, no account, no host permissions.
- [TeaStash](https://github.com/erichuang1425/teastash): a mobile-first PWA for tracking tea inventory, usage logs, expiry reminders, offline data, and optional Supabase sync.
